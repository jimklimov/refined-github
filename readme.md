...
- [](# "pr-branch-auto-delete") Automatically deletes the branch right after merging a PR, if possible. This can be toggled by "pr-branch-auto-delete" option for the browser extension.
